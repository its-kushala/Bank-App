...
public class MyJDBC {
    ...
    private static final String DB_PASSWORD = "Kushi@2002";
    ...
    public static User validateLogin(String username, String password){
        try{
            ...
            if(resultSet.next()){
                int userId = resultSet.getInt("current_balance");
            }
    ...
    public static boolean register(String username, String password){
        try{
            if(!checkUser(username)){
                ...
                PreparedStatement preparedStatement = connection.prepareStatement(
                        "INSERT INTO user(username, password, current_balance) " +
                                "VALUES(?, ?, ?)"
                );
    ...
    public static boolean transfer(User user, String transferredUser, float transferAmount){
        try{
            Connection connection = DriverManager.getConnection(DB_URL, DB_USERNAME, DB_PASSWORD);
